...
class FormularioCadastro extends Component {
  ...
  _criarNota(evento){
    ...
    this.props.criarNota(this.empresa, this.equipamento, this.observacao, this.solicitante, this.maquina,
      this.data, this.manutencao, this.profissional, this.descricao, this.sintoma);
  }
    ...
    return (
      <form className="formulario" onSubmit={this._criarNota.bind(this)}>
        ...
        <div>
          ...
          <textarea rows={5} placeholder="Descreva o que foi realizado" onChange={this._handleDescricao.bind(this)}/>
        </div>

        <div>
          <h3>Sintoma do dano</h3>
          <input type="checkbox" name="sintoma" value="Vibração" onChange={this._handleSintoma.bind(this)}/>
          <label for="sintoma">Vibração</label>

          <input type="checkbox" name="sintoma" value="Ruido excessivo" onChange={this._handleSintoma.bind(this)}/>
          <label for="sintoma">Ruido excessivo</label>

          <input type="checkbox" name="sintoma" value="Travamento" onChange={this._handleSintoma.bind(this)}/>
          <label for="sintoma">Travamento</label>

          <input type="checkbox" name="sintoma" value="" onChange={this._handleSintoma.bind(this)}/>
